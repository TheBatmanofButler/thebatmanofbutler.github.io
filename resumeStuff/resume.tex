...
\section{Projects \textit{(for more information, visit \href{https://github.com/TheBatmanofButler}{https://github.com/TheBatmanofButler})}}
  \resumeSubHeadingListStart
    % \resumeSubItem{IsThisWater}
    %   {Convolutional neural network for detecting water in satellite images}
    \resumeSubItem{The Perfect Number}
      {Visual data story on federal corporate income taxes (viewed $>$1000 times in 24 hours)}
    \resumeSubItem{YourGov.ForSale}
      {Data visualization highlighting networks of corruption in the U.S.}
    \resumeSubItem{Truffle}
      {Browser-based code editor that features rapid commenting, code visualization, and full code search}
...
\section{Programming Skills}
  \resumeSubHeadingListStart
    \resumeSubItem{Proficient}
      {JavaScript (React, TypeScript, d3.js), Python (Flask, pandas, matplotlib)}
    \resumeSubItem{Familiar}
      {C, Java, Golang, MongoDB, Angular.js, Node.js, AWS (DynamoDB, S3, Lambda, EC2, EBS, Serverless), Google Cloud, DigitalOcean, Mapbox, nginx, gunicorn, Linux, Tensorflow, scikit-learn, CircleCI}
 \resumeListEnd
